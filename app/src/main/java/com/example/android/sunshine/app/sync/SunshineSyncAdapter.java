        ...
        if (displayNotifications) {
            ...
            if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
                ...
                if (cursor.moveToFirst()) {
                    ...
                    double pressure = cursor.getDouble(INDEX_PRESSURE);
                    ...
                    // Strings for second page notification
                    String humidityText = String.format(context.getString(R.string.format_humidity),
                            humidity);
                    String pressureText = String.format(context.getString(R.string.format_pressure),
                            pressure);
                    String windText = Utility.getFormattedWind(getContext(), windSpeed, windDirection);
                    ...
                    // Create style for second page notification
                    NotificationCompat.InboxStyle secondPageStyle =
