...
public class Utility {
    ...
    /**
     * Checks if user has Android Wear App installed on their device.
     * @param c App's context
     * @return true if Android Wear app is installed, false otherwise
     */
    public static boolean isWearAppInstalled(Context c) {
        try {
            c.getPackageManager().getPackageInfo("com.google.android.wearable.app",
    ...
    /**
     * Converts a bitmap to an asset.
     * @param bitmap Bitmap to be converted
     * @return Bitmap converted to byte array asset
     */
